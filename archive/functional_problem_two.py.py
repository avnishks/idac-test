...
def define_model(input_shape, num_classes, NN_name):
    ...
    """
    # img_input = Input(shape=(None, IMG_WIDTH, IMG_HEIGHT, num_channels))
    ...
    # model.add(layers.Dense(num_classes, activation='softmax', name='prediction'))
    return model
...
def train():
    ...
    x_mnist = Conv2D(32, (3, 3), activation='relu', name='mnist_conv1')(img_input_mnist)
    ...
    x_cifar = Conv2D(32, (3, 3), activation='relu', name='cifar_conv1')(img_input_cifar)
    ...
    # model.save('four_class_cell_classification.h5')s
